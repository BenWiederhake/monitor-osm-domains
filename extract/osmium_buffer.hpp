...
#define OSMIUM_MEMORY_BUFFER_HPP_WITH_LINEAR_EXTRACT
...
#ifndef OSMIUM_MEMORY_BUFFER_HPP_WITH_LINEAR_EXTRACT
#error "This header must be included first, in order to inject the method osmium::memory::Buffer::extract_nested_buffers. Feel free to open a PR, see #369, but upstream refuses any PRs at this time."
#endif
