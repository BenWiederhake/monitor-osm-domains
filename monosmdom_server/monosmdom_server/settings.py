...
MEDIA_ROOT = secret_config.MEDIA_ROOT
AT_SUBPATH = secret_config.AT_SUBPATH
MEDIA_URL = AT_SUBPATH + "/" + SECRET_ADMIN_PATH + "media/"  # No leading, YES trailing slash
CAINFO_ROOT_AND_INTERMEDIATE = secret_config.CAINFO_ROOT_AND_INTERMEDIATE
CRAWLER_USERAGENT_EMAIL = secret_config.CRAWLER_USERAGENT_EMAIL
